...
class StochasticWindyGridworld:
    ...
    def __init__(self,initialize_model=True):
        ...
        #self.goal_locations  = [[7,3]] # [[6,2]] a vector specifying the goal location in [[x1,y1]] format
        self.goal_locations  = [[7,3],[8,3]] # [[6,2]] a vector specifying the goal locations in [[x1,y1],[x2,y2]] format
        #self.goal_rewards    = [100] # a vector specifying the associated reward with the goal in self.goal_locations, in [r1] format
